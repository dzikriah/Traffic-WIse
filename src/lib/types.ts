...
export const PredictRouteOutputSchema = z.object({
    ...
    primaryCongestionPoint: z.string().describe('The specific street or intersection causing the most delay.'),
    explanation: z.string().describe('A high-level executive summary for the overall recommendation.'),
